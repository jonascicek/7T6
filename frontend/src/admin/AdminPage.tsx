  ...
  return (
    <PageLayout containerClassName="bg-neutral-950 text-neutral-100" mainClassName="pb-20">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mb-8 rounded border border-neutral-800 bg-neutral-900/70 p-5">
          <p className="text-xs uppercase tracking-[0.18em] text-neutral-500">Kurz erklärt</p>
          <ul className="mt-3 space-y-2 text-sm text-neutral-300">
            <li>• Titel, Beschreibung und mindestens ein Bild pro Artikel sind Pflicht.</li>
            <li>• Nach dem Veröffentlichen erscheint der Post direkt auf der Startseite.</li>
            <li>• Bestehende Posts lassen sich später direkt bearbeiten oder löschen.</li>
          </ul>
        </div>
